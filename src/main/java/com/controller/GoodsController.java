...
public class GoodsController extends BaseController {
	...
	// 准备添加数据
	@RequestMapping("createGoods.shtml")
	...
	public String addGoods(Goods goods) {
		...
		return "redirect:/goods/createGoods.shtml";
	}
	...
	public String deleteGoods(String id) {
		...
		return "redirect:/goods/getAllGoods.shtml";
	}
	...
	// 显示全部数据
	@RequestMapping("getAllGoods.shtml")
	public String getAllGoods(String number, Map<String, Object> map) {
		...
		if ((Integer.parseInt(number) + 1) == 1) {
			...
			buffer.append("<a href=\"goods/getAllGoods.shtml?number=0\">首页</a>");
		}
		buffer.append("&nbsp;&nbsp;");
		if ((Integer.parseInt(number) + 1) == 1) {
			buffer.append("上一页");
		} else {
			buffer.append("<a href=\"goods/getAllGoods.shtml?number=" + (Integer.parseInt(number) - 1) + "\">上一页</a>");
		}
		buffer.append("&nbsp;&nbsp;");
		if (maxPage <= (Integer.parseInt(number) + 1)) {
			buffer.append("下一页");
		} else {
			buffer.append("<a href=\"goods/getAllGoods.shtml?number=" + (Integer.parseInt(number) + 1) + "\">下一页</a>");
		}
		buffer.append("&nbsp;&nbsp;");
		if (maxPage <= (Integer.parseInt(number) + 1)) {
			buffer.append("尾页");
		} else {
			buffer.append("<a href=\"goods/getAllGoods.shtml?number=" + (maxPage - 1) + "\">尾页</a>");
		}
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("queryGoodsByCond.shtml")
