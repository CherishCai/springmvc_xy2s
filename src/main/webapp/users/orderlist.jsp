					...
					<div class="userCenterBox boxCenterList clearfix"
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr>
								...
								<td align="center" bgcolor="#ffffff">卖家</td>
							...
							<c:forEach items="${ordersList}" var="orders">
								<tr>
									...
									<td align="center" bgcolor="#ffffff">${orders.sellername}</td>
									...
									<td align="center" bgcolor="#ffffff"><c:if
											test="${orders.status eq '未付款'}">
											<a href="index/prePay.shtml?id=${orders.ordersid}">付款</a>
										</c:if> <c:if test="${orders.status eq '已发货'}">
											<a href="index/over.shtml?id=${orders.ordersid}">确认收货</a>
										</c:if></td>
								</tr>
							</c:forEach>
						</table>
