						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<c:forEach items="${favList}" var="fav">
								<tr align="center" bgcolor="#FFFFFF">
									<td align="center"><a
										href="index/detail.shtml?id=${fav.goodsid}">${fav.goodsname}</a>
									</td>
									<td align="center">${fav.price}</td>
									<td align="center">${fav.status}</td>
									<td align="center">${fav.addtime}</td>
									<td align="center"><a
										href="index/deletefav.shtml?id=${fav.favid}"
