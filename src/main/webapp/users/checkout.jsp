...
<body>
	...
	<div class="block table">
		<form action="index/checkout.shtml" method="post" name="theForm"
			...
			<div class="flowBox">
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						...
						<td bgcolor="#ffffff" colspan="2"><input name="receiver"
							type="text" class="inputBg" id="name" /> (必填)</td>
					</tr>
					<tr>
						<td bgcolor="#ffffff">详细地址:</td>
						<td bgcolor="#ffffff" colspan="2"><input name="address"
							type="text" class="inputBg" id="cond" /> (必填)</td>
					</tr>
					<tr>
						<td bgcolor="#ffffff">联系方式:</td>
						<td bgcolor="#ffffff" colspan="2"><input name="contact"
							type="text" class="inputBg" id="cond" /> (必填)</td>
					</tr>
					<tr>
