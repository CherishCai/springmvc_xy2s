			...
			<div id="category_tree">
				...
				<dl class="clearfix">
					<c:forEach items="${cateList}" var="cate">
						<div class="dt">
							<div id="HandleLI2_1">
								<a class="a" href="index/cate.shtml?id=${cate.cateid }">${cate.catename }
				...
				<div class="xm-box">
					<h4 class="title">
						<span>${cate.catename }</span> 
							<a class="more" href="index/cate.shtml?id=${cate.cateid }">更多</a>
					</h4>
					<div id="show_new_area" class="clearfix">
						<c:forEach items="${cate.goodsList}" var="goods">
							<div class="goodsItem">
								<a href="index/detail.shtml?id=${goods.goodsid }"><img
									src="${goods.image }" alt="${goods.goodsname }" class="goodsimg" /></a><br />
								<p class="f1">
									<a href="index/detail.shtml?id=${goods.goodsid }"
										title="${goods.goodsname }">${goods.goodsname }</a>
								</p>
								原价：<font class="market">￥${goods.marketprice }元</font> <br /> 
								现价：<font
									class="f1"> ￥${goods.price }元 </font>
							</div>
						</c:forEach>
					</div>
				</div>
