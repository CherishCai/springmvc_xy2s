		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">留言板信息列表</td>
					</tr>
					<tr align="center">
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="bbs/queryBbsByCond.shtml"
								...
								查询条件<select name="cond" style="width: 100px"><option
									...
									<option value="repnum">按回复数查询</option></select>关键字<input type="text"
