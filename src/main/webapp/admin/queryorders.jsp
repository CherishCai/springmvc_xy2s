		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="center">
						...
						<td align="center" bgcolor="#ebf0f7">卖家</td>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form
								...
								查询条件<select name="cond" style="width: 100px"><option
									...
									<option value="address">按送货地址查询</option></select>关键字<input type="text"
